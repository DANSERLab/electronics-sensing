...
Sense_ADS131A04::Sense_ADS131A04(uint8_t csPin, uint8_t misoPin, uint8_t mosiPin, uint8_t sclkPin, uint8_t samplingRate){
}
...
void Sense_ADS131A04::configure(){
  ...
  adsWriteRegister(ADC1, ADC1_DEFAULT);
  adsWriteRegister(ADC2, ADC2_DEFAULT);
  adsWriteRegister(ADC3, ADC3_DEFAULT);
  adsWriteRegister(ADC4, ADC4_DEFAULT);
